...
enum layers { BASE, MOD, SYM, NAV, MEDIA, FN, TAB, GAMING, EXT };
...
#define OSM_CTL_ALT OSM(MOD_LCTL | MOD_LALT)
#define OSM_CTL_SFT OSM(MOD_LCTL | MOD_LSFT)
#define OSM_ALT_SFT OSM(MOD_LALT | MOD_LSFT)
...
const key_override_t *key_overrides[] = {&inverted_quote, &crase, &minus, NULL};
...
const uint16_t tab_combo[] PROGMEM      = {KC_A, KC_R, KC_S, KC_T, COMBO_END};
const uint16_t alt_tab_combo[] PROGMEM  = {KC_A, KC_R, KC_S, COMBO_END};
const uint16_t ctrl_tab_combo[] PROGMEM = {KC_R, KC_S, KC_T, COMBO_END};
// const uint16_t enter_combo[] PROGMEM     = {KC_N, KC_I, KC_E, COMBO_END};
...
// Layers
//    SYM
const uint16_t sym_combo[] PROGMEM = {KC_F, KC_P, COMBO_END};
//    NAV
...
// clang-format off
combo_t key_combos[] = {
    [TAB_COMBO]          = COMBO(tab_combo, MO(TAB)),
    [ALT_TAB_COMBO]      = COMBO(alt_tab_combo, LM(TAB, MOD_LALT)),
    [CTRL_TAB_COMBO]     = COMBO(ctrl_tab_combo, LM(TAB, MOD_LCTL)),
    ...
    // Layers
    //    SYM
    [SYM_COMBO]          = COMBO(sym_combo, MO(SYM)),
    //    NAV
...
enum { TD_ALT_TAB_LAYER, TD_CTRL_TAB_LAYER };

tap_dance_action_t tap_dance_actions[] = {
    [TD_ALT_TAB_LAYER]  = ACTION_TAP_DANCE_DOUBLE(OSM_ALT, LM(TAB, MOD_LALT)),
    [TD_CTRL_TAB_LAYER] = ACTION_TAP_DANCE_DOUBLE(OSM_LCTRL, LM(TAB, MOD_LCTL))};

#define TD_CTRL TD(TD_CTRL_TAB_LAYER)
#define TD_ALT  TD(TD_ALT_TAB_LAYER)
...
/*    --------------------------------------------------------------------------       ||-------------------------------------------------------------------------- */
/*   ||             |     Q     |     W     |     F     |     P     |     B   ||       ||       J    |     L     |     U    |     Y    |     ;      |     \        | */
/*   || */OSM_LCTRL ,  KC_Q     ,  KC_W     ,  KC_F     ,  KC_P     ,  KC_B    ,             KC_J    ,  KC_L     ,  KC_U    ,  KC_Y    ,  US_SCLN   , US_BSLS  ,/* |\ */
/*   ---------------------------------------------------------------------------        --------------------------------------------------------------------------- */
/*   ||             |     A     |     R     |     S     |     T     |     G   ||       ||       M    |     N     |     E    |     I    |     O      |     "        | */
/*   ||*/OSM_LSHIFT ,  KC_A     ,  KC_R     ,  KC_S     ,  KC_T     ,  KC_G    ,             KC_M    ,  KC_N     ,  KC_E    ,  KC_I    ,    KC_O    , US_DQUO  ,/* |\ */
/*   ---------------------------------------------------------------------------       ||-------------------------------------------------------------------------- */
/*   ||     ALT     |     Z     |     X     |     C     |     D     |     V   ||       ||       K    |     H     |     ,    |     .    |     /      |  R SHIFT     | */
/*   ||*/ OSM_ALT   ,  KC_Z     ,  KC_X     ,  KC_C     ,  KC_D     ,  KC_V    ,             KC_K    ,  KC_H     ,KC_COMMA  ,  KC_DOT  ,  KC_SLSH   , OSM_RSHIFT,/*|\  */
/*   ---------------------------------------------------------------------------       ||-------------------------------------------------------------------------- */
/*                                                ||    SPC    |     TAB      ||       || ENTER      |  OSL MOD    || */
/*                                                ||*/ KC_SPACE,   KC_TAB      ,          KC_ENTER   ,  OSL(MOD)// ||
/*                                                 -----------------------------       ||-------------------------- */
    ),
    [MOD] = LAYOUT_voyager(
/*   ------------------------------------------------------------------------------        ---------------------------------------------------------------------------------- */
/*   ||     DEBUG    |             |           |           |           |         ||       ||   GAMING    |           | RGB TOG       |           |           |   DELETE     | */
/*   || */  DB_TOGG  ,  ____       ,  ____     ,  ____     ,  ____     ,  ____    ,          TG(GAMING)  ,  ____     , RGB_CTRL_TOG  ,  ____     ,  ____     , KC_DELETE,/* | */
/*    r----------------------------------------------------------------------------       ||--------------------------------------------------------------------------------- */
/*   ||              |             |           |           |    {      |   }     ||       ||             |   +       |      -        |       =   |    *      |      /       | */
/*   || */   ____    ,QK_LAYER_LOCK,  ____     ,  ____     ,   KC_LCBR ,  KC_RCBR ,             ____     ,  KC_PLUS  ,   KC_MINUS    ,  KC_EQUAL ,  KC_ASTR  ,  KC_SLASH,/* | */
/*   ------------------------------------------------------------------------------       |--------------------------------------------------------------------------------- */
/*   ||  OSM CTRL SFT| OSM CTRL ALT|           | Caps Word |    [      |   ]     ||       ||             |    LEFT   |  DOWN         |    UP     |   RIGHT   |              | */
/*   ||*/OSM_CTL_SFT , OSM_CTL_ALT ,  ____     ,  CW_TOGG  ,   KC_LBRC ,  KC_RBRC ,              ____    ,  KC_LEFT  ,  KC_DOWN      ,   KC_UP   ,  KC_RIGHT ,    ____  ,/* | */
/*   ------------------------------------------------------------------------------       ||--------------------------------------------------------------------------------- */
/*   ||  LEFT META   | OSM ALT SFT |           |           |    (      |   )     ||       ||             |           |    <          |    >      |           |              | */
/*   ||*/OSM_GUI     , OSM_ALT_SFT ,  ____     ,  ____     ,  KC_LPRN  , KC_RPRN  ,             ____     ,  ____     ,   KC_LT       ,   KC_GT   ,    ____   ,    ____  ,/* | */
/*   ------------------------------------------------------------------------------       ||--------------------------------------------------------------------------------- */
/*                                                   ||           |              ||       ||             |               || */
/*                                                   ||*/ ____    ,      ____     ,               ____   ,    ____    // ||
/*                                                    -----------------------------       ||-------------------------- */
...
/*    ----------------------------------------------------------------------------       ||-------------------------------------------------------------------------- */
/*   ||             |             |     {     |     }     |    0      |    $    ||       ||     %      |    &      |    @     |    #     |     `      |              | */
/*   || */   ____   ,QK_LAYER_LOCK,  KC_LCBR  ,  KC_RCBR  ,  KC_0     ,  KC_DLR  ,             KC_PERC ,  KC_AMPR  ,  KC_AT   ,  KC_HASH ,    US_GRV  ,    ____  ,/* |\ */
/*   -----------------------------------------------------------------------------        --------------------------------------------------------------------------- */
/*   ||             |             |     (     |     )     |     [     |    ]    ||       ||     +      |    -      |    =     |    *     |      /     |              | */
...
/*   || */   ____   ,  ____        ,  ____        ,  ____      ,     ____     ,  ____       ,          ____   ,  KC_HOME     ,  KC_PGDN     ,  KC_PGUP   ,  KC_END      ,  ____    ,/* |\ */
/*    ---------------------------------------------------------------------------------------      ||----------------------------------------------------------------------------------- */
/*   ||             |              |              |            |     TAB      |            ||      ||         |  C-Left      |   C-Down     |   C-Up     |   C-Right    |              | */
/*   || */   ____   ,QK_LAYER_LOCK ,  ____        ,  ____      ,    KC_TAB    ,LSFT(KC_TAB) ,          ____   , LCTL(KC_LEFT), LCTL(KC_DOWN), LCTL(KC_UP),LCTL(KC_RIGHT),  ____    ,/* |\  */
/*   ----------------------------------------------------------------------------------------      ||----------------------------------------------------------------------------------- */
/*   ||             |   Left       |   Down       |    Up      |   Right      |            ||      ||         |   Left       |   Down       |    Up      |   Right      |              | */
/*   ||*/    ____   ,  KC_LEFT     , KC_DOWN      ,   KC_UP    ,  KC_RIGHT    ,    ____     ,          ____   ,  KC_LEFT     , KC_DOWN      ,   KC_UP    ,  KC_RIGHT    ,  ____    ,/* |\ */
/*   ----------------------------------------------------------------------------------------      ||-----------------------------------------------------------------------------------*/
/*   ||             |  Home        |   PgDown     |   PgUp     |   End        |            ||      ||         |              |              |            |              |              | */
/*   || */   ____   ,  KC_HOME     ,  KC_PGDN     ,  KC_PGUP   ,  KC_END      ,  ____       ,          ____   ,  ____        ,  ____        ,  ____      ,     ____     ,  ____    ,/* |\ */
/*   ----------------------------------------------------------------------------------------       ------------------------------------------------------------------------------------*/
/*                                                       ||   LSHIFT        |              ||      ||                |   LAYER OFF   || */
...
/*   ---------------------------------------------------------------------------       ------------------------------------------------------------------------------- */
/*   ||     SHIFT   |    A      |    S      |    D      |    F      |   G     ||       ||     H       |    J      |    K      |    L      |    ;      |  LALT        | */
/*   ||*/ KC_LSFT   ,  KC_A     ,  KC_S     ,   KC_D    ,   KC_F    ,  KC_G    ,            KC_H      ,  KC_J     ,  KC_K     ,   KC_L    , KC_SCLN   ,  KC_LALT ,/* |\*/
/*   ---------------------------------------------------------------------------       ------------------------------------------------------------------------------- */
/*   ||  LAYER EXT  |   Z       |    X      |    C      |    V      |   B     ||       ||     N       |   M       |    ,      |    .      |    /      |   SWAP HANDS | */
/*   || */ TG(EXT)  ,  KC_Z     ,   KC_X    ,   KC_C    ,   KC_V    ,  KC_B    ,            KC_N      ,  KC_M     , KC_COMM   ,   KC_DOT  , KC_SLSH   ,    SH_TT ,/* |\*/
/*   ---------------------------------------------------------------------------       ||----------------------------------------------------------------------------- */
...
/*    ------------------------------------------------------------------------------------       ||----------------------------------------------------------------------------------- */
/*   ||    TAB    |            |   ARROW UP  |            |      +       |      -         ||     ||           |              |              |            |              |              | */
/*   || */ KC_TAB ,  ____      ,     KC_UP   ,  ____      ,     KC_PLUS  ,    KC_MINUS     ,           ____   ,     ____     ,     ____     ,     ____   ,    ____      ,  ____    ,/* |\ */
/*   -------------------------------------------------------------------------------------      ------------------------------------------------------------------------------------*/
/*   ||   LALT    | ARROW LEFT |  ARROW DOWN | ARROW RIGHT|              |                ||     ||           |              |              |            |              |              | */
/*   ||*/ KC_LALT ,  KC_LEFT   ,    KC_DOWN  ,  KC_RIGHT  ,     ____     ,      ____       ,           ____   ,     ____     ,     ____     ,    ____    ,      ____    ,  ____    ,/* |\ */
/*   -------------------------------------------------------------------------------------       ||-----------------------------------------------------------------------------------*/
/*   ||           |            |             |            |              |                ||     ||           |              |              |            |              |              | */
/*   || */TG(EXT) ,  ____      ,   ____      ,  ____      ,     ____     ,      ____       ,           ____   ,     ____     ,     ____     ,    ____    ,      ____    ,  ____    ,/* |\ */
/*   -------------------------------------------------------------------------------------       ||-----------------------------------------------------------------------------------*/
/*                                                          ||           |                ||     ||           |   LAYER OFF   || */
/*                                                          ||*/ ____    ,   TG(EXT)       ,          ____    ,   TG(EXT)// ||
/*                                                           -----------------------------       ||--------------------------------- */
    ),
    [TAB] = LAYOUT_voyager(
/*   --------------------------------------------------------------------------        ---------------------------------------------------------------------------------- */
...
/*   -------------------------------------------------------------------------        ---------------------------------------------------------------------------------- */
/*   ||             |           |         | SHIFT TAB  |   TAB     |         ||       ||             |           |               |          |            |              | */
/*   ||*/    ____   ,  ____     , ____    ,LSFT(KC_TAB),  KC_TAB   ,  ____    ,             ____     ,  ____     ,   ____        ,   ____   ,    ____    ,    ____  ,/* |\ */
/*   --------------------------------------------------------------------------       ||--------------------------------------------------------------------------------- */
/*   ||             |           |           |          |           |         ||       ||             |           |               |          |            |              | */
/*   || */   ____   ,  ____     ,  ____     ,  ____    ,  ____     ,  ____    ,             ____     ,  ____     ,   ____        ,   ____   ,    ____    ,    ____  ,/* |\  */
/*   --------------------------------------------------------------------------       ||--------------------------------------------------------------------------------- */
/*                                                ||  S-TAB       | LAYER OFF||       ||             |    TAB        || */
/*                                                ||*/LSFT(KC_TAB),   TG(TAB) ,               ____   ,    KC_TAB  // ||
/*                                                 ----------------------------       ||-------------------------- */
    ),
...
bool get_combo_term(uint16_t combo_index, combo_t *combo) {
