...
enum layers { BASE, MOD, SYM, NAV, MEDIA, FN, TAB, GAMING };
...
#define OSM_CTL_ALT OSM(MOD_RCTL | MOD_LALT)
...
/*    --------------------------------------------------------------------------       ||-------------------------------------------------------------------------- */
/*   ||             |     Q     |     W     |     F     |     P     |     B   ||       ||       J    |     L     |     U    |     Y    |     ;      |     \        | */
/*   || */OSM_LSHIFT,  KC_Q     ,  KC_W     ,  KC_F     ,  KC_P     ,  KC_B    ,             KC_J    ,  KC_L     ,  KC_U    ,  KC_Y    ,  US_SCLN   , US_BSLS  ,/* |\ */
/*   ---------------------------------------------------------------------------        --------------------------------------------------------------------------- */
/*   ||             |     A     |     R     |     S     |     T     |     G   ||       ||       M    |     N     |     E    |     I    |     O      |     "        | */
/*   ||*/OSM_LCTRL  ,  KC_A     ,  KC_R     ,  KC_S     ,  KC_T     ,  KC_G    ,             KC_M    ,  KC_N     ,  KC_E    ,  KC_I    ,    KC_O    , US_DQUO ,/* |\ */
/*   ---------------------------------------------------------------------------       ||-------------------------------------------------------------------------- */
/*   ||     GUI     |     Z     |     X     |     C     |     D     |     V   ||       ||       K    |     H     |     ,    |     .    |     /      |              | */
/*   ||*/KC_LEFT_GUI,  KC_Z     ,  KC_X     ,  KC_C     ,  KC_D     ,  KC_V    ,             KC_K    ,  KC_H     ,KC_COMMA  ,  KC_DOT  ,  KC_SLSH   ,    ____  ,/* |\  */
/*   ---------------------------------------------------------------------------       ||-------------------------------------------------------------------------- */
/*                                                ||    SPC    | OSL MOD      ||       || ENTER      |  OSL MOD    || */
/*                                                ||*/ KC_SPACE, OSL(MOD)      ,          KC_ENTER   ,  OSL(MOD)// ||
/*                                                 -----------------------------       ||-------------------------- */
    ),
    [MOD] = LAYOUT_voyager(
/*   ---------------------------------------------------------------------------        ---------------------------------------------------------------------------------- */
/*   ||     DEBUG   |           |           |           |           |         ||       ||             |          |                |           |           |   DELETE     | */
/*   || */  DB_TOGG ,  ____     ,  ____     ,  ____     ,  ____     ,  ____    ,              ____    ,  ____    ,  ____          ,  ____     ,  ____     , KC_DELETE,/* |\ */
/*    r-------------------------------------------------------------------------       ||--------------------------------------------------------------------------------- */
/*   ||             |           |           |           |    {      |   }     ||       ||   GAMING    |           | RGB TOG       |          |            |              | */
/*   || */   ____   ,  ____     ,  ____     ,  ____     ,   KC_LCBR ,  KC_RCBR ,          TG(GAMING)  ,  ____     , RGB_CTRL_TOG  ,   ____   ,    ____    ,    ____  ,/* |\ */
/*   ---------------------------------------------------------------------------        ---------------------------------------------------------------------------------- */
/*   || OSM CTRL ALT|  OSM_ALT  |           | Caps Word |    [      |   ]     ||       ||             |           |               |          |            |              | */
/*   ||*/OSM_CTL_ALT,  OSM_ALT  ,  ____     ,  CW_TOGG  ,   KC_LBRC ,  KC_RBRC ,             ____     ,  ____     ,   ____        ,   ____   ,    ____    ,    ____  ,/* |\ */
/*   ---------------------------------------------------------------------------       ||--------------------------------------------------------------------------------- */
/*   ||             |           |           |           |    (      |   )     ||       ||             |           |               |          |            |              | */
/*   || */   ____   ,  ____     ,  ____     ,  ____     ,  KC_LPRN  , KC_RPRN  ,             ____     ,  ____     ,   ____        ,   ____   ,    ____    ,    ____  ,/* |\  */
/*   ---------------------------------------------------------------------------       ||--------------------------------------------------------------------------------- */
/*                                                ||           |              ||       ||             |               || */
/*                                                ||*/ ____    ,      ____     ,               ____   ,    ____    // ||
/*                                                 -----------------------------       ||-------------------------- */
...
/*   ----------------------------------------------------------------------------------------       ------------------------------------------------------------------------------------*/
/*                                                       ||   LSHIFT        | LAYER OFF    ||      ||                |   LAYER OFF   || */
/*                                                       ||*/ KC_LEFT_SHIFT ,  TG(NAV)      ,               ____      ,    TG(NAV) // ||
/*                                                        -----------------------------------      ||-------------------------- */
    ),
