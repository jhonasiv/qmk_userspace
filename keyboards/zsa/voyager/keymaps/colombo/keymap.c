...
/*   ---------------------------------------------------------------------------        ------------------------------------------------------------------------------ */
/*   ||  SWAP HANDS |     1     |     2     |     3     |     4     |     5   ||       ||        6    |     7     |     8     |     9     |     0     |              | */
/*   || */   SH_TT  ,  KC_1     ,  KC_2     ,  KC_3     ,  KC_4     ,  KC_5    ,              KC_6    ,  KC_7     ,  KC_8     ,  KC_9     ,  KC_0     ,  ____    ,/* |\*/
/*    --------------------------------------------------------------------------        ------------------------------------------------------------------------------ */
/*   ||      CTRL   |    Q      |    W      |    E      |    R      |   T     ||       ||      Y      |    U      |    I      |    O      |    P      |              | */
/*   || */ KC_LCTL  ,   KC_Q    ,  KC_W     ,   KC_E    ,   KC_R    ,  KC_T    ,             KC_Y     ,   KC_U    ,  KC_I     ,   KC_O    ,   KC_P    ,  ____    ,/* |\*/
/*   ---------------------------------------------------------------------------       ------------------------------------------------------------------------------- */
/*   ||     SHIFT   |    A      |    S      |    D      |    F      |   G     ||       ||     H       |    J      |    K      |    L      |    ;      |              | */
/*   ||*/ KC_LSFT   ,  KC_A     ,  KC_S     ,   KC_D    ,   KC_F    ,  KC_G    ,            KC_H      ,  KC_J     ,  KC_K     ,   KC_L    , KC_SCLN   ,  ____    ,/* |\*/
/*   ---------------------------------------------------------------------------       ------------------------------------------------------------------------------- */
/*   ||             |   Z       |    X      |    C      |    V      |   B     ||       ||     N       |   M       |    ,      |    .      |    /      |              | */
/*   || */   ____   ,  KC_Z     ,   KC_X    ,   KC_C    ,   KC_V    ,  KC_B    ,            KC_N      ,  KC_M     , KC_COMM   ,   KC_DOT  , KC_SLSH   ,  ____    ,/* |\*/
/*   ---------------------------------------------------------------------------       ||----------------------------------------------------------------------------- */
/*                                                ||   SPACE   |     ENTER    ||       ||                |   LAYER OFF   || */
/*                                                ||*/ KC_SPC  ,   KC_ENTER    ,               ____      ,    TG(FN)  // ||
/*                                                 -----------------------------       ||-------------------------- */
    ),
